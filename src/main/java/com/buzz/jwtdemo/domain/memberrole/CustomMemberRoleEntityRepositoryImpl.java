...
public class CustomMemberRoleEntityRepositoryImpl extends QuerydslRepositorySupport implements CustomMemberRoleEntityRepository{
    ...
    @Override
	public List<MemberPojo.MemberWithRoleDto> viewMemberRoleList(LocalDateTime startDate,LocalDateTime endDate){
    	...
    	**********************************************************************************************/
    	...
    	return from(memberRole)
    			.select(
    					Projections.bean(MemberPojo.MemberWithRoleDto.class
    							,memberRole.id
    							,memberRole.roleName
    							, Projections.bean(MemberPojo.MemberDto.class
